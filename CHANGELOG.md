...
- `docs/DESIGN.md` — full architecture specification, reviewed across five adversarial passes
  (49 findings resolved: 8 high, 27 medium, 14 low). Covers the KB directory format, SQLite schema,
