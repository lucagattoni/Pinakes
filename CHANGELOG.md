...
- `docs/DESIGN.md` — full architecture specification, reviewed across six adversarial passes
  (54 findings resolved: 10 high, 29 medium, 15 low). Covers the KB directory format, SQLite schema,
