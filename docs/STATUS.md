...
`search` returns the document. The earlier claim that it worked unedited was wrong. **0.15.0 has
been verified to install and report its version from the index (20260805 22:52), not to complete
...
| First upload | 20260728 17:16 UTC · latest 20260805 22:50 UTC (0.15.0) |
