...
`search` returns the document. The earlier claim that it worked unedited was wrong. **0.12.0 has
been verified to install and report its version from the index (20260805 18:23), not to complete
...
| First upload | 20260728 17:16 UTC · latest 20260805 18:09 UTC (0.12.0) |
