...
**Latest release: 0.15.0** · last reviewed 20260805 22:48
...
`search` returns the document. The earlier claim that it worked unedited was wrong. **0.14.0 has
been verified to install and report its version from the index (20260805 22:26), not to complete
...
| First upload | 20260728 17:16 UTC · latest 20260805 22:24 UTC (0.14.0) |
