...
| the listing names the table each hunk falls in, and a multi-line array is not one | T3 | `tests/test_cli_upgrade.py::test_the_listing_names_the_table_each_hunk_falls_in`, `tests/test_cli_upgrade.py::test_a_multi_line_array_is_not_reported_as_a_table` |
