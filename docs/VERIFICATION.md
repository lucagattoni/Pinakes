...
| two identical hops in one question refuse — one retrieval written twice clears the hop floor and can move `liftable` upward | G2 | `tests/test_eval.py::test_the_probe_refuses_a_question_whose_two_hops_are_identical` |
