...
| the remedy names the **oldest** archived version — "stamped from X or later" excludes nothing | T3 | `tests/test_cli_upgrade.py::test_an_unarchived_recorded_version_refuses_with_a_remedy` |
