...
| a three-file edit that passes every content leg is caught by history | T1 | `tests/test_template_drift.py::test_a_three_file_edit_is_caught_by_the_history_leg` |
...
| an archive not yet committed is not a second commit | T1 | `tests/test_template_drift.py::test_an_uncommitted_archive_is_not_a_second_commit` |
