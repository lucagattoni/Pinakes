...
| the artifact records the retrieval, embedding **and reranker** settings that produced the numbers, not only the corpus | G2 | `tests/test_eval.py::test_the_artifact_records_the_configuration_that_produced_the_numbers` |
