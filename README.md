...
> is specified in [`docs/DESIGN.md`](docs/DESIGN.md) and has been through five adversarial review
...
history — five passes, 49 findings, including the three factual errors the review caught.
