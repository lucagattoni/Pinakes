...
JSON-unencodable shapes the product refuses, and the non-string top-level keys it refuses. None of those shapes appears in the committed corpora, which is why the
